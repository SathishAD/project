...
public class SpringBatchConfig {
	...
	//private Resource output_db_to_csv =new ClassPathResource("output_db_to_csv.csv");
	private Resource output_db_to_csv = new FileSystemResource("D:/demoProject/src/main/resources/output_db_to_csv.csv");
	
	//private Resource output_csv_to_csv =new ClassPathResource("output_csv_to_csv.csv");
	private Resource output_csv_to_csv = new FileSystemResource("D:/demoProject/src/main/resources/output_csv_to_csv.csv");
	@Bean
	...
	public FlatFileItemReader<Transaction> csvReader(){
		...
		flatFileItemReader.setResource(new ClassPathResource("1000BTRecords.csv"));
	...
	public FlatFileItemReader<Transaction> csvReaderCSVToCSV(){
		...
		FlatFileItemReader<Transaction> flatFileItemReader=new FlatFileItemReader<Transaction>();
		flatFileItemReader.setResource(new ClassPathResource("output_db_to_csv.csv"));
